...
int  gen_Skip(int x);                                      // Skip locations for future backpatch
void gen_Backtrack(int l);                                 // Backtracks to previous location
void gen_Restore();                                        // Restore current position to highest ungenerated position
